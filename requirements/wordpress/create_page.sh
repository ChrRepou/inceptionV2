...
if [ -f "$WORDPRESS_DIR/wp-config.php" ]; then
  ...
  wp core install --path="$WORDPRESS_DIR" --url=crepou.42.fr --title=Inception --admin_user=ChristinaRepou --admin_password=ChristinaRepou --admin_email=crepou@student.42heilbronn.de --skip-email --allow-root
